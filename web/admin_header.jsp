                    ...
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
                            <div class="input-group custom-search-form">
                                <input type="text" class="form-control" placeholder="Search..." style="bottom: 1px;">
                        ...
                        <li>
                            <a href="list_user.jsp"><i class="fa fa-table fa-fw"></i> List Of User's</a>
                        </li>
                        <li>
                            <a href="list_contact_us.jsp"><i class="fa fa-table fa-fw"></i> List Of Contact Us</a>
                        </li>
                        <li>
