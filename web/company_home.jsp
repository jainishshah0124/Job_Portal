						...
						<div class="col-md-4 col-sm-4 col-xs-12 paddright">
							<div class="input-group">
								...
								<span>
                                                    ...
                                                    <div class="center">
                                                        <button class="btn-default" onclick="search('job','user')">ADVANCE JOB SEARCH <i class="fa fa-plus-square-o" aria-hidden="true"></i>
							</button>
						</div>	
					</div>
				</div>
                                                    ...
                                                    <div class="slide-detail" id="user" style="display: none">
				<div class="container">
					<div class="slider-caption">
						<div class="off"></div>
						<h1>Find Candidate</h1>
                                                <%
                                                    ...
                                                    psmt=con.prepareStatement("select * from tbl_sector");
                                                    rs=psmt.executeQuery();
                                                %>
                                                <form action="search_candidate.jsp">
                                                    <input type="hidden" value="job_title" name="orderby"/>
						<div class="col-md-4 col-sm-4 col-xs-12 paddleft">
                                                    <select class="form-control" name="ddl_sector">
                                                        <option value="0">Select Sector</option>
						...
						<div class="col-md-4 col-sm-4 col-xs-12 paddright">
							<div class="input-group">
								...
								<span>
                                                    ...
                                                    <div class="center">
                                                         <button class="btn-default" onclick="search('user','job')">ADVANCE JOB SEARCH <i class="fa fa-plus-square-o" aria-hidden="true"></i>
							</button>
						</div>	
					</div>
				</div>
