<%-- 
    Document   : header_doc
    Created on : Apr 6, 2017, 12:09:34 AM
    Author     : Jainish Shah
--%>
...
<body>
        <div id="wrapper">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse" style="padding-bottom: 1px;">
                <ul class="nav navbar-nav side-nav" style="font-size: 16px;">
                    <li>
                        <a href="admin_homepage.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dashboard</a>
                    </li>
                    <li id="doctors.jsp">
                        <a href="list_user.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;List of User's</a>
                    </li>
                    
                    <li>
                        <a href="list_contact_us.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;List of Contact Us</a>
                    </li>
                    
                    <li>
                        <a href="list_company.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;List of Company</a>
                    </li>
